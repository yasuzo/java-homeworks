...
public class LinkedListIndexedCollection extends Collection {
    ...
    /**
     * Method calls {@code processor.process(.)} for each element of this collection in order they were added.
     *
     * @param processor Processor whose {@code process(.)} method will be called for each element in the collection
     * @throws NullPointerException If given processor is {@code null}
     */
    @Override
