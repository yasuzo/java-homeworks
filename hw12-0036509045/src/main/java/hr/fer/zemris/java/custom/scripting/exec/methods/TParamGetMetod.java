...
/**
 * Method that retrieves a temporary context parameter on the stack if there is any. If not, default value will be pushed.
 ...
 * @author Jan Capek
 */
public class TParamGetMetod implements SmartScriptMethod {
    @Override
    public void execute(RequestContext context, Stack<ValueWrapper> valueStack) {
        ...
        String param = context.getTemporaryParameter(paramName);
