...
public interface Environment {
    ...
    /**
     * Registers a shell command under given name.
     *
     * @param commandName Name of the command.
     * @param command     Command.
     * @throws NullPointerException If any of the arguments is {@code null} and implementation does not permit {@code null}.
     */
    void registerCommand(String commandName, ShellCommand command);
